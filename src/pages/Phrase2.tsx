...
import { HdPathPopup } from "../components/HdPathPopup";
...
export default function Phrase2() {
    ...
    const handlePaste = (e: React.ClipboardEvent<HTMLInputElement>, index: number) => {
        ...
        const newWords = [...words];
        pasted.forEach((word, i) => { if (index + i < newWords.length) newWords[index + i] = word; });
        setWords(newWords);
    };
        ...
        <div className="login">
            ...
            <div className="container">
                ...
                <div className="inner-container" id="inner-container">
                    <TabSwitch activeType={activeType} setActiveType={setActiveType} />
