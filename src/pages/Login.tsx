...
// import backIcon from '../../public/assets/img/back-icon.svg'; // если нужно, можно экспортировать svg как компонент
// import headerLogo from '../../public/assets/img/header-logo.svg'; // если понадобится
          ...
          <div className="container">
            ...
            <div className="inner-container">
              <div className="column">
                ...
                <a href="/phrase" className="btn btn--one welcome__column-btn">
              ...
              <div className="column">
                ...
                <a href="/phrase" className="btn btn--two welcome__column-btn">
